  ...
  ctx.body = html`
    ...
    <html>
      ...
      <body>
        ...
        <p>
          Hello ${ctx.ip} from worker ${workerId}!
          <script>
            document.currentScript.parentElement.className = aphrodite.css(
              Styles.hover
            );
          </script>
        </p>
        <p>
          If using Chrome, you can set
          <a href="chrome://flags/#allow-insecure-localhost"
            >chrome://flags/#allow-insecure-localhost</a
          >
        </p>
        <div>
          Node versions:
...
(() => {
  const ipMarkoTemplate = marko.load(require.resolve("./view/ip.marko.html"), {
    writeToDisk: false
  });
